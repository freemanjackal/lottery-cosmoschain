...
./rly chains add -f lotterychain.json

# Add relayer account (Recover by mnemonic help for developing)
./rly keys restore lottery relayer "clutch amazing good produce frequent release super evidence jungle voyage design clip title involve offer brain tobacco brown glide wire soft depend stand practice"
...
./rly ch edit lottery key relayer
...
./rly lite init lottery -f
./rly lite init bandchain -f
#rly lite init band-cosmoshub -f

# Create path(specific connection between chain)
#rly pth gen  lottery transfer band-cosmoshub transfer transfer
./rly pth gen  lottery lottery bandchain oracle oracle
